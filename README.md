This is a simple tool for tracking knitting projects!

When you knit, you would typically follow a 'pattern' which explains what types of knits you need to do, how many rows to do them for, and how many times to repeat the process.
...
I plan to add some minor customisability to the tool at some point (e.g., custom keys).
